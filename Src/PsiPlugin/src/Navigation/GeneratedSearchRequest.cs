...
{
  public class GeneratedSearchRequest : SearchRequest
  {
    protected readonly DeclaredElementEnvoy<IDeclaredElement> myTarget;
    private readonly ISolution mySolution;
    private string myCachedTitle;

    public GeneratedSearchRequest(IDeclaredElement declaredElement)
    {
